    ...
    public static void main(String[] args)
       {
        ...
        bstTest = uploadData( "./doc/8491063.txt" );
        ...
        System.out.println( "Remove id 576650" );
        bstTest.removeNode( new StudentClassNode( "", 576650, 'X', 0.00 ) );
        System.out.println( "\nInorder display:\n" 
              + bstTest.outputInOrder() );
        System.out.println( "Remove id 123456" );
        bstTest.removeNode( new StudentClassNode( "", 123456, 'X', 0.00 ) );
        System.out.println( "\nInorder display:\n" 
              + bstTest.outputInOrder() );
        System.out.println( "Remove id 323273" );
        bstTest.removeNode( new StudentClassNode( "", 323273, 'X', 0.00 ) );
        System.out.println( "\nInorder display:\n" 
              + bstTest.outputInOrder() );
        System.out.println( "Remove id 904592" );
        bstTest.removeNode( new StudentClassNode( "", 904592, 'X', 0.00 ) );
        System.out.println( "\nInorder display:\n" 
              + bstTest.outputInOrder() );
            ...
            while( compareString( inputString, "EndOfFile") != 0 )
               {
                ...
                inStudent = new StudentClassNode( inputString, inputID,
                                                  (char)inputGender, inputGPA );
                
                System.out.println( inStudent.toString() );
                
                bstData.insert( inStudent );
